...
CREATE TABLE src_inventarsystem.Wartung (
    ...
    TechnikerNr INT NOT NULL, -- Logischer Verweis auf Mitarbeiter im Helpdesksystem
...
CREATE TABLE src_ticketsystem.Kunde (
    ...
    StandortID INT NOT NULL -- Logischer Verweis auf Standort im Ticketsystem
);
...
INSERT INTO src_inventarsystem.Gerät (GeräteNr, Gerätetyp, Hersteller, Modell, StandortID, Anschaffungsdatum)
SELECT 
    i AS GeräteNr,
...
INSERT INTO src_inventarsystem.Wartungsvertrag (VertragsNr, GeräteNr, Vertragsart, Beginn, Ende, Kosten_pro_Jahr)
SELECT 
...
INSERT INTO src_inventarsystem.Wartung (WartungsNr, GeräteNr, Datum, Wartungsart, TechnikerNr, Kosten)
SELECT 
...
INSERT INTO src_ticketsystem.Ticket (TicketNr, KundenNr, GeräteNr, Erstellungsdatum, Kategorie, Priorität, Status, SLA_Zielzeit_Minuten)
SELECT 
    1000 + i AS TicketNr,
...
INSERT INTO src_ticketsystem.Bearbeitung (BearbeitungsNr, TicketNr, MitarbeiterNr, Datum, Bearbeitungszeit_Minuten, Aktionstyp)
SELECT 
